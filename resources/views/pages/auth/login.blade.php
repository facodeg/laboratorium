...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('sneat') }}/assets/vendor/css/rtl/theme-default.css"
    ...
    <!-- Vendor -->
    <link rel="stylesheet"
        href="{{ asset('sneat') }}/assets/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
        ...
        <div class="authentication-inner row">
            ...
            <div class="d-none d-lg-flex col-lg-7 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    <img src="{{ asset('sneat') }}/assets/img/illustrations/auth-login-illustration-light.png"
                        alt="auth-login-cover" class="img-fluid my-5 auth-illustration"
                        data-app-light-img="illustrations/auth-login-illustration-light.png"
                        data-app-dark-img="illustrations/auth-login-illustration-dark.png" />

                    <img src="{{ asset('sneat') }}/assets/img/illustrations/bg-shape-image-light.png"
