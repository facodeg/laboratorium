                                    ...
                                    <div class="col-md mb-md-0 mb-2">
                                        <div class="form-check custom-option custom-option-icon">
                                            <label class="form-check-label custom-option-content" for="customRadioIcon1">
                                                ...
                                                <input name="role" class="form-check-input" type="radio" value="admin" id="customRadioIcon1" checked />
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md mb-md-0 mb-2">
                                        <div class="form-check custom-option custom-option-icon">
                                            <label class="form-check-label custom-option-content" for="customRadioIcon2">
                                                ...
                                                <input name="role" class="form-check-input" type="radio" value="doctor" id="customRadioIcon2" />
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div class="form-check custom-option custom-option-icon">
                                            <label class="form-check-label custom-option-content" for="customRadioIcon3">
                                                ...
                                                <input name="role" class="form-check-input" type="radio" value="user" id="customRadioIcon3" />
                                            </label>
                                        </div>
                                    </div>
                                </div>
